...
```bash
export FOREGENOMICS_PGX_REPORT_PATH=/Users/june-young/Research_Local/08_GWAS_browser/ForeGenomics_PGx/trial/results.tsv
```
...
```bash
export GWAS_CACHE_REQUIRE_PUBMED=1
```
